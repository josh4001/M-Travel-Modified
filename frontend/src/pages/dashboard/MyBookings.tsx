...
export default function MyBookings() {
  ...
  const loadAllBookings = useCallback(async () => {
    ...
    const normalizedStored: UnifiedBooking[] = userStored.map(b => ({
      ...
      vehicleImage: b.vehicleImage || 'https://images.unsplash.com/photo-1594502184342-2e12f877aa73?auto=format&fit=crop&w=800&q=80',
      ownerId: b.ownerId,
        ...
        if (Array.isArray(supaData)) {
          normalizedSupa = supaData.map((sb: any) => {
            ...
            return {
              ...
              vehicleImage: vImg || 'https://images.unsplash.com/photo-1594502184342-2e12f877aa73?auto=format&fit=crop&w=800&q=80',
